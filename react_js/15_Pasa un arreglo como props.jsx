{
    ...
    // El componente hijo entonces tiene acceso a la propiedad del arreglo colors. Los métodos de arreglo,./// como join() pueden ser usados al acceder a la propiedad. const ChildComponent = (props) => <p>{props.colors.join(', ')}</p>
    //* Esto unirá a todos elementos colors del arreglo en una cadena separada por comas y se convertirá en: <p>green, blue, red</p> Más tarde, aprenderemos sobre otros métodos comunes para representar arreglos de datos en React.
}
        ...
        render() {
            return (
                <div>
                    ...
                    <h2>Today</h2>
                    { /* Cambia el código debajo de esta línea */}
                    <List tasks={['Estudiar,Cocinar,Dormir']} />
                    <h2>Tomorrow</h2>
                    <List  tasks={['Caminar','Estudiar','Dormir']}  />
                    { /* Cambia el código encima de esta línea */}
                </div>
            );
        }
